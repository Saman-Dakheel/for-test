...
package com.hurricaneDevSam.videoDownloaderSam.adapter;
    ...
    public void onBindViewHolder(@NonNull SavedHolder holder, final int position) {
        ...
        holder.thumbnail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Uri fileUri = FileProvider.getUriForFile(context, "com.hurricaneDevSam.videoDownloaderSam.fileprovider", list.get(position));
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (i == R.id.download_delete) {
                    ...
                    Uri fileUri = FileProvider.getUriForFile(context, "com.hurricaneDevSam.videoDownloaderSam.fileprovider", file);
